...
def test_config():
    ...
    test_config.failure_fqn = '{}/fail.txt'.format(tc.TEST_DATA_DIR)
    test_config.failure_log_file_name = 'fail.txt'
    test_config.retry_fqn = '{}/retry.txt'.format(tc.TEST_DATA_DIR)
    test_config.retry_file_name = 'retry.txt'
    test_config.success_fqn = '{}/good.txt'.format(tc.TEST_DATA_DIR)
    test_config.success_log_file_name = 'good.txt'
    test_config.rejected_fqn = '{}/rejected.yml'.format(tc.TEST_DATA_DIR)
    test_config.progress_fqn = '{}/progress.txt'.format(tc.TEST_DATA_DIR)
